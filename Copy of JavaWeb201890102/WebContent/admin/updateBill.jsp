...
<div class="container clearfix">
   ...
   <table border=1>
     <tr>
       ...
       while(it.hasNext()){
     	  b = (billDTO)it.next();  
     	 if((b.getUsersID().equals(usersID))){
       %>
     <tr>
        <td><input type="text" readOnly="ture" name="usersID" value=<%=b.getUsersID()%>></td>
        <td><input type="text" name="price" value=<%=b.getPrice()%>></td>
        <td><input type="text" name="flag" value=<%=b.getFlag()%>></td>
        <td><input type="text" name="waID" value=<%=b.getWaID()%>></td>
