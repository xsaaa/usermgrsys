...
<form action="updateWaterticketServlet">
   <table border=1>
     <tr>
        <td>waID</td>
        <td>type</td>
       ...
       while(it.hasNext()){
     	 ...
     	 if((wt.getWaID().equals(waID))){
       %>
     <tr>
        <td><input type="text" readOnly="ture" name="waID" value=<%=wt.getWaID()%>></td>
        <td><input type="text" name="type" value=<%=wt.getType()%>></td>
        <td><input type="text" name="price" value=<%=wt.getPrice()%>></td>
        <td><input type="text" name="flag" value=<%=wt.getFlag()%>></td>
