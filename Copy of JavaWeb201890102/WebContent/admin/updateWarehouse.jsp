...
<div class="container clearfix">
  ...
  <form action="updateWarehouseServlet">
   <table border=1>
     <tr>
        <td>type</td>
        <td>amount</td>
       ...
       %>
     <tr>
        <td><input type="text" readOnly="ture" name="type" value=<%=w.getType()%>></td>
        <td><input type="text" name="amount" value=<%=w.getAmount()%>></td>
        <td><input type="text" name="price" value=<%=w.getPrice()%>></td>
        <td><input type="text" name="flag" value=<%=w.getFlag()%>></td>
