...
<div class="container clearfix">
   ...
   <table border=1>
      <tr>
       ...
       %>
     <tr>
         <td><input type="checkbox" name="check" value=<%=u.getUsersID()%>></td>
         ...
         <td>
          <a href="updateUsers.jsp?usersID=<%=u.getUsersID()%>"><span style="font-size:16px;">update</span></a>
          <a href="deleteUsersServlet?usersID=<%=u.getUsersID()%>"><span style="font-size:16px;">delete</span></a>
        </td>
     </tr>
